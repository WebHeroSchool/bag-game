...
function winCard (wraps) {
    ...
    cardBackWin.innerHTML = '<img src="img/card-back-win.png" alt="card">';
...
function losingCards (arrayWithOutBag) {
    arrayWithOutBag.forEach(card => {
        ...
        cardBackLosing.innerHTML = '<img src="img/card-back-losing.png" alt="card">';
